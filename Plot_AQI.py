...
if __name__ == "__main__":
    ...
    plt.plot(range(0, 365), range(0, 365), lst2018, label="2018 data")
    plt.plot(range(0, 364), range(0, 364), lst2019, label="2019 data")
    plt.plot(range(0, 365), range(0, 365), lst2020, label="2020 data")
    plt.plot(range(0, 121), range(0, 121), lst2021, label="2021 data")
    plt.xlabel("Day")
    plt.ylabel("PM 2.5")

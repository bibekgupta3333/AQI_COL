...
class WeatherData(models.Model):
	...
	# Temperature data
	temp_avg = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)  # T
	temp_max = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)  # TM
	temp_min = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)  # Tm
	
	# Atmospheric data
	sea_level_pressure = models.DecimalField(max_digits=7, decimal_places=2, null=True, blank=True)  # SLP
	...
	visibility = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)  # VV
	
	# Wind data
	wind_speed = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)  # V
	wind_gust = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)  # VM
	...
	def __str__(self):
		return f"{self.location} - {self.date} (AQI: {self.aqi})"
...
class whole_dataset(models.Model):
	"""DEPRECATED: Use WeatherData instead"""
	date = models.CharField(max_length=120)
